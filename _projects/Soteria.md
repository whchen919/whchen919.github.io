...
A multi-disciplinary design optimization (MDO) program based on genetic algorithm (GA) was developed to search for an optimal set of design parameters in the early stage of the design process.
