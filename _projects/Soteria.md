...
<div class="row">
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/Soteria/Sotaria_2.png" title="The Team" class="img-fluid rounded z-depth-1" %}
        <div class="caption">
            Team Soteria.
        </div>
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/Soteria/Sotaria_3.png" title="Certificate" class="img-fluid rounded z-depth-1" %}
        <div class="caption">
